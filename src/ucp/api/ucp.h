...
enum ucp_worker_params_field {
    ...
    UCP_WORKER_PARAM_FIELD_RMA_BATCH_CB_ARG = UCS_BIT(10) /**< RMA batch callback argument */
};
...
typedef struct ucp_worker_params {
    ...
    */
    ...
    /**
     * RMA batch completion callback argument. This argument is passed to the RMA batch
     * completion callback. This value is optional.
     * If it's not set (along with its corresponding bit in the field_mask -
     * UCP_WORKER_PARAM_FIELD_RMA_BATCH_CB_ARG), it will default to NULL.
     * @note This argument is passed to the RMA batch completion callback as
     *       @ref ucp_rma_batch_callback_t::arg.
     */
    void                    *rma_batch_cb_arg;
} ucp_worker_params_t;
 ...
 */
struct ucp_rma_batch_recv_param {
    uint64_t field_mask;
    /* future extensions may be added here */
};
